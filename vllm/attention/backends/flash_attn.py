...
class FlashAttentionMetadata(AttentionMetadata):
    ...
    def advance_step(self,
        ...
        # print("FlashAttentionMetadata turn_prefills_into_decodes", turn_prefills_into_decodes) # no
...
def unified_flash_attention(
    ...
    if kv_cache.numel() > 0:
        ...
        # print("unified_flash_attention attn_metadata.slot_mapping", attn_metadata.slot_mapping.flatten())
        # print("unified_flash_attention kv_cache_dtype", kv_cache_dtype)
        # print("unified_flash_attention k_scale", k_scale)
        # print("unified_flash_attention v_scale", v_scale)
        # print("unified_flash_attention shapes", key.shape, value.shape, kv_cache[0].shape, kv_cache[1].shape)
